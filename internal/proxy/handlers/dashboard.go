...
<body class="bg-gray-900 text-gray-100 min-h-screen">
    <div class="container mx-auto px-4 py-6 max-w-6xl">
        ...
        <div class="mt-6 text-center py-3 border-t border-gray-700">
            ...
            <span class="text-gray-500 text-xs"><span id="status">Ready</span> • <span class="text-gray-300 font-bold">v0.1.2</span> • <a href="/healthz" class="hover:text-gray-300">Health</a></span>
        </div>
    </div>
